...
func (c *userV1Client) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedUserV1Server) Get(context.Context, *GetRequest) (*emptypb.Empty, error) {
